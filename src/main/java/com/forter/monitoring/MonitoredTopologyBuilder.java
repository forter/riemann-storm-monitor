...
public class MonitoredTopologyBuilder extends TopologyBuilder {
    ...
    public BoltDeclarer setBolt(String id, IRichBolt bolt, Number parallelism_hint) {
        final MonitoredBolt monitoredBolt = (bolt instanceof MonitoredBolt) ? (MonitoredBolt) bolt : new DefaultMonitoredBolt(bolt);
        return super.setBolt(id, monitoredBolt, parallelism_hint);
    }

    @Override
    public SpoutDeclarer setSpout(String id, IRichSpout spout, Number parallelism_hint) {
        final MonitoredSpout monitoredSpout = (spout instanceof MonitoredSpout) ? (MonitoredSpout)spout: new DefaultMonitoredSpout(spout);
